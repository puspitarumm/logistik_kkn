...
class BarangKeluarController extends Controller
{
    public function __construct()
    {
        ...
        public function delete($id_brg_keluar){
            BarangKeluar::where('id_brg_keluar',$id_brg_keluar)->delete();
            session([
                'error'  => ['Barang berhasil dihapus'],
            ]);
            return redirect('barangkeluar');
        }
        ...
        public function printPdf(Request $request){
            $data['mahasiswa']=Mahasiswa::where('kode_lokasi',$request['lokasi'])->get();
            // return $data;
        ...
        public function uploadBukti(Request $request){
            ...
            $path['path'] = $file->move(public_path('bukti_penyerahan'), $new_name);
